...
//INSERT
$query = " INSERT INTO patient (  icPatient, password, patientFirstName, patientLastName,  patientDOB, patientGender,   patientEmail,doctor )
VALUES ( '$icPatient', '$password', '$patientFirstName', '$patientLastName', '$patientDOB', '$patientGender', '$patientEmail' ,'$doctor') ";
...
<html lang="en">
    <head>
        ...
        <title>Patient Appointment Application</title>
        <!-- Bootstrap -->
...
<!--        <link rel="stylesheet" href="https://formden.com/static/cdn/font-awesome/4.4.0/css/font-awesome.min.css" />-->
    ...
    <body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php">UHealthcare</a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
						...
						<li><a href="adminlogin.php">Doctor</a></li>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <form class="form" role="form" method="POST" accept-charset="UTF-8" >
                                                <div class="form-group">
                                                    <label class="sr-only" for="icPatient">IC</label>
                                    ...
                                    <form action="<?php $_PHP_SELF ?>" method="POST" accept-charset="utf-8" class="form" role="form">
										...
										<div class="col-xs-4 col-md-4">
                                                <select name="doctor" class = "form-control input-lg" required>
                                                    ...
                                                    <option value="Gowry shuthan">Gowry shuthan(Skin Specialist)</option>
                                                    <option value="Abinaya">Abinaya (ENT Specialist)</option>
													<option value="Lathurshikan">Lathursigan (Eye Specialist)</option>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <!-- date textbox end serach available date doctor home page-->
					  <script>
        ...
        <section id="content-1-9" class="content-1-9 content-block"><!-- /.container -->
        </section>
        <!-- forth section end -->
        <!-- footer start -->
